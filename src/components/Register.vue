              ...
              <v-card width="400">
                ...
                <v-card-text class="pb-0">
                  ...
                  <v-text-field
                    ...
                    :rules="
                      $store.getters['validation/inputRules'](['required'])
                    "
                  ...
                  <v-text-field
                    ...
                    :rules="
                      $store.getters['validation/inputRules']([
                        'email',
                        'required',
                      ])
                    "
                  ...
                  <v-text-field
                    ...
                    :rules="
                      $store.getters['validation/inputRules'](['password'])
                    "
                    prepend-inner-icon="mdi-lock"
                    :append-icon="
                      user.password.show ? 'mdi-eye' : 'mdi-eye-off'
                    "
                  ...
                  <v-text-field
                    ...
                    prepend-inner-icon="mdi-lock"
                    :append-icon="
                      user.passwordCheck.show ? 'mdi-eye' : 'mdi-eye-off'
                    "
                    :type="user.passwordCheck.show ? 'text' : 'password'"
                    @click:append="
                      user.passwordCheck.show = !user.passwordCheck.show
                    "
                  />
                </v-card-text>
                <v-card-actions>
                  ...
                  >
                    <template #label>
                      <div>
                        <component
                          :is="item.link ? 'a' : 'span'"
                          v-for="(item, index) in user.policy.content"
                          :key="item + index"
                          :href="item.link || ''"
                          target="_blank"
                          @click.stop
